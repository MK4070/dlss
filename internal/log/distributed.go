...
// single-server, non-replicated log
//
// log for this server, where this server will store the user's records
...
type StreamLayer struct {
	ln              net.Listener
	serverTLSConfig *tls.Config // incoming connections
	peerTLSConfig   *tls.Config // outgoing connections
}
...
// outgoing raft connections prefix
const RaftRPC = 1
...
// blocks until cluster has elected a leader or times out
